<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewmissingreports.aspx.cs" Inherits="E_Police.viewmissingreports" %>
            ...
            <div class="col-md-5">
                ...
                <div class="card">
                    <div class="card-body" style="background-color: white">
                        ...
                        <div class="row">
                            <div class="col">
                                <label>Add information about Missing Person</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Information about missing person" TextMode="MultiLine"></asp:TextBox>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body" style="background-color: white">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:epoliceDBConnectionString %>" SelectCommand="SELECT [report_id], [user_name], [user_id], [missing_person_name], [age], [date_missing], [place_last_seen], [time_missing], [description_missing_person], [missing_person_image] FROM [missing_report_tbl] WHERE ([pincode] = @pincode)">
                                <SelectParameters>
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12" style="font-size: large">
                                                                Missing Person's Name-<asp:Label ID="Label2" runat="server" Text='<%# Eval("missing_person_name") %>' Font-Bold="True" Font-Size="Large"></asp:Label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                Date Of Missing-<asp:Label ID="Label3" runat="server" Text='<%# Eval("date_missing") %>' Font-Bold="True"></asp:Label>
                                                                &nbsp;| Time Of Misssing-<asp:Label ID="Label4" runat="server" Text='<%# Eval("time_missing") %>' Font-Bold="True"></asp:Label>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="col-12">
                                                                Age Of Missing Person-<asp:Label ID="Label5" runat="server" Text='<%# Eval("age") %>' Font-Bold="True" Font-Size="Medium"></asp:Label>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="col-12">
                                                                Description Of Missing Person-<asp:Label ID="Label6" runat="server" Text='<%# Eval("description_missing_person") %>' Font-Bold="True" Font-Size="Medium"></asp:Label>
                                                            </div>
                                                        </div>

                                                    </div>
                                                    <div class="col-lg-2">
                                                        <asp:Image class="img-fluid" ID="Image1" runat="server" ImageUrl='<%# Eval("missing_person_image") %>' Height="150px" Width="100px" ImageAlign="NotSet" BorderStyle="Solid" BackColor="#FF9933" />
                                                    </div>
                                                </div>
                                            </div>
                                        </ItemTemplate>
